...
let core: [String] = [
    ...
    "NavigationServer2DManager.swift",
    "NavigationServer3DManager.swift",
    "Node.swift",
    "Node2D.swift",
    "Node3D.swift",
    "Node3DGizmo.swift",
...
let threeD: [String] = [
    ...
    "BoneConstraint3D.swift",
    "BoneTwistDisperser3D.swift",
    "BoxOccluder3D.swift",
    "BoxShape3D.swift",
    "CCDIK3D.swift",
    ...
    "ConvertTransformModifier3D.swift",
    "ConvexPolygonShape3D.swift",
    "CopyTransformModifier3D.swift",
    "Curve3D.swift",
    ...
    "JacobianIK3D.swift",
    "Joint3D.swift",
    "JointLimitation3D.swift",
    "JointLimitationCone3D.swift",
    "KinematicCollision3D.swift",
    "Label3D.swift",
    "Light3D.swift",
    "LightmapGI.swift",
    "LightmapProbe.swift",
    "LimitAngularVelocityModifier3D.swift",
    "LookAtModifier3D.swift",
    "Marker3D.swift",
    "MeshInstance3D.swift",
    "ModifierBoneTarget3D.swift",
...
let xr: [String] = [
    ...
    "OpenXRAnchorTracker.swift",
    "OpenXRAndroidThreadSettingsExtension.swift",
    "OpenXRExtensionWrapper.swift",
    "OpenXRFrameSynthesisExtension.swift",
    "OpenXRFutureExtension.swift",
    "OpenXRFutureResult.swift",
    "OpenXRMarkerTracker.swift",
    "OpenXRPlaneTracker.swift",
    "OpenXRRenderModel.swift",
    "OpenXRRenderModelExtension.swift",
    "OpenXRRenderModelManager.swift",
    "OpenXRSpatialAnchorCapability.swift",
    "OpenXRSpatialCapabilityConfigurationAnchor.swift",
    "OpenXRSpatialCapabilityConfigurationAprilTag.swift",
    "OpenXRSpatialCapabilityConfigurationAruco.swift",
    "OpenXRSpatialCapabilityConfigurationBaseHeader.swift",
    "OpenXRSpatialCapabilityConfigurationMicroQrCode.swift",
    "OpenXRSpatialCapabilityConfigurationPlaneTracking.swift",
    "OpenXRSpatialCapabilityConfigurationQrCode.swift",
    "OpenXRSpatialComponentAnchorList.swift",
    "OpenXRSpatialComponentBounded2DList.swift",
    "OpenXRSpatialComponentBounded3DList.swift",
    "OpenXRSpatialComponentData.swift",
    "OpenXRSpatialComponentMarkerList.swift",
    "OpenXRSpatialComponentMesh2DList.swift",
    "OpenXRSpatialComponentMesh3DList.swift",
    "OpenXRSpatialComponentParentList.swift",
    "OpenXRSpatialComponentPersistenceList.swift",
    "OpenXRSpatialComponentPlaneAlignmentList.swift",
    "OpenXRSpatialComponentPlaneSemanticLabelList.swift",
    "OpenXRSpatialComponentPolygon2DList.swift",
    "OpenXRSpatialContextPersistenceConfig.swift",
    "OpenXRSpatialEntityExtension.swift",
    "OpenXRSpatialEntityTracker.swift",
    "OpenXRSpatialMarkerTrackingCapability.swift",
    "OpenXRSpatialPlaneTrackingCapability.swift",
    "OpenXRSpatialQueryResultData.swift",
    "OpenXRStructureBase.swift",
...
let editor: [String] = [
    ...
    "EditorExportPlatformVisionOS.swift",
